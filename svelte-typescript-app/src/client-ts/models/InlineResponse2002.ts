...
export function InlineResponse2002FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2002 {
    ...
    return {
        ...
        'results': !exists(json, 'results') ? undefined : ((json['results'] as Array<any>).map(AuthorFromJSON)),
    };
}
...
export function InlineResponse2002ToJSON(value?: InlineResponse2002 | null): any {
    ...
    return {
        ...
        'results': value.results === undefined ? undefined : ((value.results as Array<any>).map(AuthorToJSON)),
    };
}
